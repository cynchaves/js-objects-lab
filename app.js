...
game.party.push(pokemon[146], pokemon[141], pokemon[79]);
console.log(game.party);
...
game.party.splice(0, 4, pokemon[1], pokemon[147], pokemon[142], pokemon[80]);
console.log(game.party);
...
function completed() {
  for (let i = 0; i < game.gyms.length; i++) {
    if ((game.gyms[i].completed === false) && (game.gyms[i].difficulty < 6)) {
